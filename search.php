...
$blocked_qstrs = [ 'client', 'sclient', 'oq', 'sourceid', 'source', 'gs_lcrp', 'gs_lp', 'sca_esv', 'sxsrf', 'ei', 'sei', 'iflsig', 'fbs' ];
...
$response = str_replace("<body",'<script>var defglog = 1;</script><script src="/blocker.js"></script><body',$response);
